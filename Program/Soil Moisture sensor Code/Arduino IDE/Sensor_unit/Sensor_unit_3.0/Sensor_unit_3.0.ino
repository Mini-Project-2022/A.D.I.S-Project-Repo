...
{ float moisture_percentage;
  ...
  if (Firebase.ready() && signupOK && (millis() - sendDataPrevMillis > 9000 || sendDataPrevMillis == 0))
  {
    ...
    Serial.println(Firebase.RTDB.getFloat(&Reading, "Soil Moisture(in Percentage) = ")? String(Reading.to<float>()).c_str():Reading.errorReason().c_str());
